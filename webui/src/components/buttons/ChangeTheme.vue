    ...
    <v-menu v-model="menu">
      <template v-slot:activator="{ props }">
        <v-btn :ripple="false" v-bind="props">
          <v-icon size="26" icon="mdi-theme-light-dark" />
          <div class="text-body-1 font-weight-bold">Theme</div>
        </v-btn>
      ...
      <v-card>
        ...
        <!-- TODO :item="items" similar to the notifications pop-up -->
        <v-list density="compact">
          <!-- prepend-avatar="/flags/uk.svg" -->
          <v-list-item
            class="text-left"
            title="English"
